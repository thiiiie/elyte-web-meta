...
const formSchema = z.object({
	...
	address: z
		.string({ required_error: "Digite seu endereço" })
		.min(1, "Digite seu endereço"),
	number: z
	...
	state: z
		.string({ required_error: "Digite o estado" })
		.min(1, "Digite o estado"),
});
		...
		>
			...
			{cepLoaded && (
				<>
					...
					<Button className="w-fit px-10 mt-2" type="submit">
						Continuar
					</Button>
				</>
			)}
