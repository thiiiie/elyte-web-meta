...
import { PiCalendarBlank, PiCheckCircle, PiCurrencyCircleDollarLight, PiPixLogo, PiUserCircle } from "react-icons/pi"
...
export const LoadingForm = () => {
  ...
  useEffect(() => {
    ...
    const installmentsEncrypted = localStorage.getItem(storage.keys.installment);
    ...
    const installments = JSON.parse(
      decryptData(installmentsEncrypted)
    );
