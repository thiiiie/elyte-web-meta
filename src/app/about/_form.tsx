...
const formSchema = z.object({
  cpf: z.string({ required_error: 'Digite um CPF' }).min(11, "O CPF deve ter 11 dígitos"),
  name: z.string({ required_error: 'Digite seu nome' }).min(1, 'Digite seu nome'),
  birthdate: z.string({ required_error: 'Digite seu aniversário' }).min(1, 'Digite seu aniversário'),
  motherName: z.string({ required_error: 'Digite o nome da sua mãe' }).min(1, 'Digite o nome da sua mãe'),
  whatsapp: z.string({ required_error: 'Digite seu WhatsApp' }).min(11, 'Digite seu WhatsApp'),
      ...
      {isValidCPF && (
        <>
          ...
          <fieldset>
            ...
            <RadioGroup defaultValue="male" className="flex items-center mt-2" onValueChange={e => setValue('gender', e)}>
