...
const formSchema = z.object({
  bank: z.string({ required_error: 'Digite seu banco' }).min(1, 'Digite o banco'),
  pixKey: z.string({ required_error: 'Digite sua chave Pix' }).min(4, 'Chave Pix muito curta'),
})
...
export const PixForm = () => {
  ...
  function onSubmit(data: FormValues) {
    const encryptedInfo = encryptData(
      JSON.stringify(data)
    );
